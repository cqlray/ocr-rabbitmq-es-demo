...
@Slf4j
@Service
@RabbitListener(queues = {QueueConfig.ARCHIVE_QUEUE, QueueConfig.SUBJECT_QUEUE})
...
//        }
    ...
    @RabbitHandler
    public void getMessageFromSubject(@Payload SubjectDto subjectDto){
        log.info("{} need to change status at {}", subjectDto, DateUtil.now());
    }
}
